...
public interface IExpenseService
{
    ...
    Task<PagedExpensesDto> GetPagedAsync(int? year, int? month, string? currency, int? paymentMethodId, string? search, int page, int pageSize, CancellationToken ct = default);
